...
//  BetterRest
//
//  Created by Santiago Gonzalez on 04/01/2024.
//
import SwiftUI
import CoreML
...
struct ContentView: View {
    ...
    private var wakeUpCalculated: String{
    ...
    func calculateBedtime() -> String {
        do {
            ...
            return "Sorry, there was a problem calculating bed time"
        }
    }
